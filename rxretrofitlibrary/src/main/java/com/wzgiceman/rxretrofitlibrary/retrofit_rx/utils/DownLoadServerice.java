 ...
 * 虽然已经有了断点下载的功能  但是从未测试过android系统的下载任务功能  这里做个备份
 */
...
//                install(context);
        ...
        HiPermission.create(this)
                ...
                .msg(this.getString(R.string.update_app))//更新的
                ...
                .checkMutiPermission(new PermissionCallback() {
                    ...
                    public void onFinish() {
                        //请求成功 先进行删除操作
                        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/lxd_library/App/")!=null){
    ...
    public static void install(Context context) {
        ...
        File file = new File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/lxd_library/App"
                , "lxd" + versionName + ".apk");
    ...
    private void startDownload(String downUrl) {
        ...
        //设置下载存放的文件夹和文件名字
        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS + "/lxd_library/App", "lxd" + versionName + ".apk");
        //设置下载时或者下载完成时，通知栏是否显示
        request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
        request.setTitle("下载最新版本");
        //执行下载，并返回任务唯一id
