...
public class HttpManager {
    ...
    public void doHttpDeal(BaseApi basePar) {
        /*rx处理*/
        ProgressSubscriber<BaseResultEntity> subscriber = new ProgressSubscriber(basePar, onNextListener);

        Observable observable = basePar.getObservable(RxRetrofitApp.getRetrofitInstance())
                /*失败后的retry配置*/
